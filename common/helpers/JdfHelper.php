 ...
 * @name: Hijri_Shamsi,Solar(Jalali) Date and Time public functions
...
class JdfHelper extends Component
{
    ...
    /*	F	*/
    public function jmktime($jm='',$jd='',$jy='',$h='',$m='',$s='',$none='',$timezone='Asia/Tehran'){
