                ...
                <tr class="form-options-item">
                    ...
                    <td>
                        ...
                        <?php if (!$modelOptionValue->isNewRecord): ?>
                            ...
                            <?= Html::activeHiddenInput($modelOptionValue, "[{$index}]option_id"); ?>

                            <?= Html::activeHiddenInput($modelOptionValue, "[{$index}]image"); ?>

                        <?php endif; ?>

                        <?php

                        $modelImage = $modelOptionValue->image;
...
//                        }
                        ...
                        <?= $form->field($modelOptionValue, "[{$index}]image")->label(false)->widget(FileInput::classname(), [
