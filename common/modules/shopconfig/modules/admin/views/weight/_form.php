...
/* @var $model common\modules\shopconfig\models\WeightClass */
/* @var $form yii\widgets\ActiveForm */


$this->title = ($model->isNewRecord) ? Yii::t('app','Create Weight') : Yii::t('app','Update Weight') ;
        ...
        <div class="widget-box">
            ...
            <div class="widget-header">
                <h4 class="widget-title">
                    <?php echo ($model->isNewRecord) ? Yii::t('app','Create Weight') : Yii::t('app','Update Weight') ?>
                </h4>
                ...
                <span class="widget-toolbar">
                    ...
                    <?= Html::a('<i class="glyphicon glyphicon-floppy-saved"></i>',($model->isNewRecord) ? [ Yii::$app->controller->id.'/create'] : [Yii::$app->controller->id.'/update','id'=> $model->weight_class_id ] , [
                        'data' => [
                            'method' => 'post',
                        ]
                    ])?>

                    <a href="<?= Url::to(['/shopconfig/admin/weight'])?>" >
