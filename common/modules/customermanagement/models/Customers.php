...
class Customers extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return [
            'default' => ['customer_group_id', 'customer_name', 'customer_username', 'customer_password' ,'access_token' ,'customer_image' ,'customer_email' ,'phone' ,'mobile' ,'is_block', 'customer_parent_id','customer_max_credit' ,'is_agency' ,'user_id' ,'create_time' ,'update_time'],
