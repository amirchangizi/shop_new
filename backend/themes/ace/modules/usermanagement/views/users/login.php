...
use app\modules\user\models\ForgotForm;
                            ...
                            <div id="login-box" class="login-box visible widget-box no-border">
                                <div class="widget-body">
                                    <div class="widget-main">
                                        ...
                                        <?php
                                            $model = new LoginForm();
                                            $form = ActiveForm::begin(['action'=>Yii::$app->urlManager->createUrl('user/default/login'),'id' => 'login-form']);
                                ...
                                <div class="widget-body">
                                    <div class="widget-main">
                                        ...
                                        <?php
                                            ...
                                            $form = ActiveForm::begin(['action'=>Yii::$app->urlManager->createUrl('user/default/forgot'),'id' => 'Retrieve-form']); ?>
                                ...
                                <div class="widget-body">
                                    <div class="widget-main">
                                        ...
                                        <?php
                                            ...
                                            $form = ActiveForm::begin(['action'=>Yii::$app->urlManager->createUrl('user/default/register'),'id' => 'register-form']); ?>
                                            ...
                                            <fieldset>
                                                ...
                                                <label class="block clearfix">
                                                            <span class="block input-icon input-icon-right">
                                                                <?= $form->field($register, 'username')->textInput(['class'=>'form-control','placeholder'=>Yii::t('app',"Username") ])->label(false) ?>
                                                                <i class="ace-icon fa fa-user"></i>
                                                            </span>
                                                </label>
