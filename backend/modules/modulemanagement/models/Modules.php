...
class Modules extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['module_path' ,'title' ,'module_name', 'position'], 'required'],
            ...
            [['added_user'], 'exist', 'skipOnError' => true, 'targetClass' => User::className(), 'targetAttribute' => ['added_user' => 'user_id']],
            [['modified_user'], 'exist', 'skipOnError' => true, 'targetClass' => User::className(), 'targetAttribute' => ['modified_user' => 'user_id']],
        ];
    }
