        ...
        <div class="container">
            <div class="col-md-6" data-animate="fadeInDown">
                <ul class="menu pull-right">
                    ...
                    <li><?= Html::a('ارتباط با ما', ['contact'], ['class'=>'']) ?>
                    </li>
                    <li><?= Html::a('ورود / ثبت نام', ['register'], ['class'=>'']) ?>
                    </li>
                    
                </ul>
            </div>
            <div class="col-md-6 offer" data-animate="fadeInDown">
                <a class="navbar-brand home pull-left" href="index.html" data-animate-hover="bounce">
                    
                    <img src="img/logo.jpg" alt="Obaju logo" class="hidden-xs">
                    <img src="img/logo.jpg" alt="Obaju logo" class="visible-xs"><span class="sr-only"></span>
                </a>
            </div>
        </div>
        ...
        <div class="container">
            <div class="navbar-header">
                <div class="navbar-buttons">
                    ...
                    <div class=" navbar-toggle">
                        <?= Html::a('', ['basket'], ['class'=>'small-box btn-default fa fa-shopping-cart']) ?>
                    </div>
            ...
            <div class="navbar-buttons">
                ...
                <div class="navbar-collapse collapse right" id="basket-overview">
                    ...
                    <?= Html::a('<span class=" fa fa-shopping-cart"></span>  سبد خرید ', ['address'], ['class'=>'larg-box navbar-btn btn btn-primary']) ?>
                </div>
                <!--/.nav-collapse -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        ...
                        <ul>
                            <li><a href="text.html">حساب کاربری</a>
                            </li>
                            <li><a href="text.html">تاریخچه سفارشات</a>
                            </li>
                            <li><a href="faq.html">لیست دلخواه</a>
                            </li>
                            <li><a href="contact.html">پرسش و پاسخ ها</a>
                            </li>
                        </ul>
                        <hr>
                        <ul>
                            ...
                            <li><a href="register.html">ثبت نام</a>
                            </li>
                        </ul>
